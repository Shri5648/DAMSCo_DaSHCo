...
class Muon_qnorm(Optimizer):
    def __init__(self, params, qval=1.0, lr=0.05, weight_decay=1.2, momentum=0.95, compressor=NoneCompressor(),device="cpu",devices=[],comm_set=['x'],lr_decay="none",nvlink=False):
