...
class Muon_qnorm(Optimizer):
    def __init__(self, params, qval=1.0, lr=0.05, weight_decay=0.05, momentum=0.95, compressor=NoneCompressor(),device="cpu",devices=[],comm_set=['x'],lr_decay="none",nvlink=False):
        ...
        super().__init__(params,compressor=compressor,optim_name="ESMuonqnorm",comm_set=comm_set,device=device,topology="ring",devices=devices, nvlink=nvlink,lr_decay=lr_decay,lr=lr)
