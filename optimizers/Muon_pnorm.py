...
class Muon_pnorm(Optimizer):
    def __init__(self, params, pval=1.5, lr=0.05, weight_decay=1.2, momentum=0.95, compressor=NoneCompressor(),device="cpu",devices=[],comm_set=['x'],lr_decay="none",nvlink=False):
